...
export default {
  ...
  global: {
    ...
    input:
      'bg-transparent appearance-none focus:outline-none focus:ring-0 focus:shadow-none',
    label:
      'block mb-1 font-bold text-sm font-mono text-gray-700 dark:text-gray-200',
  ...
  'family:box': {
    ...
    label:
      '$reset text-sm text-gray-700 ml-2 dark:text-gray-300 font-medium font-mono mt-1 select-none',
    wrapper: 'flex items-center mb-1',
  },
  'family:button': {
    input:
      '$reset inline-flex items-center btn btn-primary btn-md focus-visible:outline-2 focus-visible:outline-accent focus-visible:outline-offset-2 formkit-disabled:bg-gray-400 formkit-loading:before:w-4 formkit-loading:before:h-4 formkit-loading:before:mr-2 formkit-loading:before:border formkit-loading:before:border-2 formkit-loading:before:border-r-transparent formkit-loading:before:rounded-3xl formkit-loading:before:border-white formkit-loading:before:animate-spin',
    wrapper: 'mb-1',
  ...
  'family:dropdown': {
    dropdownWrapper:
      'my-2 w-full drop-shadow-lg  [&::-webkit-scrollbar]:hidden',
    emptyMessageInner:
