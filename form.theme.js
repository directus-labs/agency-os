...
export default {
  ...
  'family:box': {
    decorator:
      'block relative h-5 w-5 mr-2 rounded-md  bg-gradient-to-b from-transparent to-gray-200 ring-1 ring-gray-300 peer-checked:ring-primary-500 text-transparent peer-checked:text-primary-500',
    decoratorIcon:
  ...
  'family:dropdown': {
    ...
    inner:
      'max-w-md relative flex ring-1 ring-gray-300 focus-within:ring-primary-500 focus-within:ring-2 rounded mb-1 formkit-disabled:focus-within:ring-gray-300 formkit-disabled:focus-within:ring-1 [&>span:first-child]:focus-within:text-primary-500',
  ...
  'family:text': {
    inner:
      'flex items-center max-w-md ring-1 ring-gray-300 focus-within:ring-primary-500 focus-within:ring-2 [&>label:first-child]:focus-within:text-primary-500 rounded mb-1',
    input:
  ...
  select: {
    inner:
      'flex relative items-center rounded mb-1 ring-1 ring-gray-300 focus-within:ring-primary-500 focus-within:ring-2 [&>span:first-child]:focus-within:text-primary-500',
    input:
  ...
  textarea: {
    inner:
      'flex rounded mb-1 ring-1 ring-gray-300 focus-within:ring-primary-500 [&>label:first-child]:focus-within:text-primary-500',
    input:
  ...
  toggle: {
    ...
    track:
      'p-0.5 min-w-[3em] relative rounded-full transition-all bg-gray-400 peer-checked:bg-primary-500 peer-checked:[&>div:last-child]:left-full peer-checked:[&>div:last-child]:-translate-x-full peer-checked:[&>div:first-child:not(:last-child)]:left-0 peer-checked:[&>div:first-child:not(:last-child)]:translate-x-0',
...
const textClassification = {
  label:
    'block mb-1 font-bold text-sm formkit-invalid:text-red-500 text-gray-700',
  inner: `font-ui flex items-center max-w-md
        border
        border-gray-300
