			...
			>
				<div class="flex flex-col p-5 sm:p-6">
					<div class="flex items-center">
						<Icon v-if="collection.icon" :name="convertIconName(collection.icon)" class="w-10 h-10 text-accent" />
					</div>
					<div>
						<TypographyHeadline :content="collection.title" size="sm" />
						<p class="font-mono text-gray-500 dark:text-gray-300 line-clamp-3 text-md sm:line-clamp-3">
