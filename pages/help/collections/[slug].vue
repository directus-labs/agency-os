		...
		<section class="max-w-full mt-8">
			...
			<div class="flex flex-col gap-10 pt-4 max-sm:gap-8 max-sm:pt-2">
				<div>
					...
					<div class="mt-5 font-mono text-gray-500">{{ collection.articles.length }} articles</div>
				</div>
				<div class="flex flex-col gap-5 p-2 border-2 dark:border-gray-600 rounded-br-xl rounded-tl-xl">
					<NuxtLink
