		...
		<section class="relative items-center w-full py-12">
			...
			<div class="grid gap-6 mt-4 md:grid-cols-3">
				...
				>
					...
					>
						<img :src="fileUrl(project.image)" class="object-cover transition duration-300 group-hover:scale-110" />
						<div
						...
						>
							<div class="p-8">
								...
								<div class="mt-2">
									<VBadge class="mb-2 mr-2" v-for="(item, itemIdx) in project.built_with" size="lg" color="#0f172a">
										{{ item }}
									</VBadge>
								</div>
							</div>
