...
<template>
	<div class="py-12">
		...
		>
			<img class="absolute inset-0 object-cover w-full h-full" :src="fileUrl(project.image)" />
			...
			>
				...
				<p class="mt-4 font-mono font-semibold text-gray-300 md:text-lg font-display">
					{{ project.summary }}
				</p>
			</div>
		</div>
