			...
			<header>
				<div class="md:flex">
					...
					<div class="relative w-full max-w-3xl pt-6 md:px-6">
						...
						>
							<img :src="fileUrl(page.image)" class="object-cover w-full h-full saturate-0 dark:brightness-90" alt="" />
				...
				>
					<div class="relative px-8 py-8 overflow-hidden md:px-16 rounded-br-2xl rounded-tl-2xl md:py-12">
						<div
						...
						<div class="relative">
							...
							<p class="mt-4 font-mono font-semibold md:text-lg font-display dark:text-gray-200">
								{{ page.summary }}
							</p>
						</div>
					</div>
