	...
	<div class="relative flex flex-col flex-1 h-full">
		...
		<div class="relative flex flex-1">
			<div class="absolute py-4 inset-0 flex bottom-[56px] overflow-y-auto">
				<ol ref="chatWindow" v-auto-animate class="relative flex flex-col w-full px-4 space-y-4">
					...
					>
						...
						<p
							:class="[
								{
									'bg-gray-200 dark:bg-gray-600 dark:text-white text-gray-800 rounded-br-none': !isCurrentUser(message),
									'bg-accent text-white rounded-bl-none': isCurrentUser(message),
								},
