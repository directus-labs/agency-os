			...
			<div class="relative p-4 space-y-4">
				...
				>
					<NuxtLink class="" :href="`/posts/${post.slug}`">
						<div :class="['relative rounded-br-2xl rounded-tl-2xl overflow-hidden h-32 w-full ']">
							<img
					...
					<NuxtLink class="h-full" :href="`/posts/${post.slug}`">
						<!-- Icon -->
						<p class="mt-2 font-serif text-lg font-semibold text-gray-900 dark:text-white group-hover:text-accent">
							{{ post.title }}
						</p>
