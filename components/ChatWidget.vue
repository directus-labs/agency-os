	...
	<div>
		...
		>
			<div id="wrapper" class="absolute inset-0 flex flex-col">
				...
				<MessengerMenu class="block px-4 py-4 border-t dark:border-t-gray-700" v-if="showMenu" />
			</div>
		</Motionable>
		<!-- Button -->
		<button
		...
		>
			<div>
				...
				<Icon name="heroicons:chat-bubble-left-ellipsis" v-if="!isOpen" class="w-8 h-8" />
