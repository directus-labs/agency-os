...
<template>
	...
	>
		...
		<div v-for="row in data.rows" :key="row.id" class="relative flex-col items-start mt-16 align-middle">
				...
				<div class="relative items-center gap-12 m-auto lg:inline-flex">
					<div class="max-w-xl text-left">
						<div>
							...
							<TypographyProse v-if="row.content" :content="row.content" class="mt-4 font-mono" />
						</div>
					</div>
				</div>
				<div
