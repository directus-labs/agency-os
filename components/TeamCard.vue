...
<template>
	<div class="opacity-0 cursor-pointer select-none animate-fade-in" @click="flipped = !flipped">
		<div class="relative w-full h-full overflow-hidden group rounded-br-3xl rounded-tl-3xl">
			<!-- Front of Team Card -->
					...
					<div class="mt-2 space-y-4">
						...
						>
							<div class="flex items-center justify-center flex-none text-black border-r border-black w-14">
								<Icon class="w-8 h-8 text-gray-900 hover:opacity-75" :name="`uil:${link.service}`" />
							</div>
			...
			<div class="absolute z-10 bottom-4 left-7 right-7">
				...
				<p class="font-mono text-sm font-bold tracking-widest uppercase word-spacing-tight text-accent">
					{{ person.job_title }}
				</p>
			</div>
