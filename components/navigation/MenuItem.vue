				...
				>
					<div class="p-4">
						...
						>
							...
							>
								<Icon v-if="childItem.icon" :name="convertIconName(childItem.icon)" class="w-10 h-10 text-accent" />
							</div>
							<div class="flex-auto">
								<NuxtLink :href="getUrl(childItem)" class="block font-bold text-white uppercase">
									{{ childItem.title }}
