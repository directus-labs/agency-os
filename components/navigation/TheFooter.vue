...
<template>
	...
	>
		...
		<!-- Bottom -->
		<div
			class="py-6 mx-auto border-t dark:border-t-gray-700 max-w-7xl md:flex md:items-center md:justify-between lg:px-16"
		>
			...
			<div class="mt-8 md:mt-0 md:order-1">
				<span class="mt-2 font-serif text-gray-700 dark:text-gray-300">
					...
					<NuxtLink href="/" class="mx-2 hover:text-accent" rel="noopener noreferrer">{{ title }}.</NuxtLink>
					All rights reserved.
				</span>
