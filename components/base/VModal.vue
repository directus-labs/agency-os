			...
			<div class="fixed inset-0 z-10 overflow-y-auto">
				<div class="min-h-screen px-4 text-center">
					<TransitionChild
						...
						leave-to="opacity-0"
					>
						<DialogOverlay class="fixed inset-0 bg-gray-800 opacity-50 dark:opacity-90 dark:bg-gray-900" />
					</TransitionChild>
					...
					>
						...
						>
							...
							<DialogTitle v-if="title" as="h3" class="text-lg font-medium leading-6 text-gray-900 dark:text-gray-200">
								{{ title }}
							</DialogTitle>
							<slot />
						</div>
