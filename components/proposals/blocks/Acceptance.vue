...
<template>
	<BlockContainer>
		<div
			class="relative max-w-3xl p-2 mx-auto overflow-hidden text-gray-900 bg-transparent border-2 dark:bg-transparent border-accent rounded-br-3xl rounded-tl-3xl"
		>
			<div class="relative px-6 py-8 overflow-hidden bg-gray-100 dark:bg-gray-800 rounded-br-2xl rounded-tl-2xl">
				<div class="space-y-2 text-center">
					<span class="px-3 py-4 rounded-tr-lg rounded-bl-lg bg-accent">
						<Icon name="solar:check-read-outline" class="w-12 h-12 text-white" />
					</span>
					<TypographyHeadline content="Accept Proposal" />
					<p class="font-mono dark:text-gray-200">
